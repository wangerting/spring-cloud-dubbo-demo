package com.wanget.model.enums;
 ...
 */
public enum CommonStatusEnum implements Serializable {
    /**
     * 禁用
     */
    DISABLE_0(0, "禁用"),
    ...
    private static Map<Integer, CommonStatusEnum> MAP;
    public static Map<Integer, String> NAME_MAP = Maps.newHashMap();

    static {
        Map<Integer, CommonStatusEnum> map = Maps.newHashMap();
